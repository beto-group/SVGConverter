...
<div align="center">
  <!-- TOP PURPLE LINKS -->
  <a href="https://beto.group"><img src="https://img.shields.io/badge/WEBSITE-7A46F1?style=for-the-badge&logo=data:image/svg%2Bxml;base64," alt="WEBSITE"></a>
...
<div align="center">
  <img src="assets/svgconverter.clip.gif" alt="SVG Converter Preview" width="100%">
</div>
...
* ⚙️ **Data Extraction**: Extracts and decompresses JSON data from Obsidian Excalidraw notes and converts it via UMD Excalidraw export libraries.
...
* 🖼️ **SVG Sub-Asset Embedding**: Embedded SVG sub-drawings are resolved and compiled into a single unified composite vector image.
...
| **[`data/`](data/)** | Local data caches including fonts and Excalidraw svg samples. |
